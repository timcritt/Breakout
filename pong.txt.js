...
class Breakout {
    constructor() {
        ...
        this.scrollSpeed = 0.125;
        this.sideScrollSpeed = 0.25;
        this.bgX = -50;
        this.bgY = 0;
    }
    startGame = () => {
    ...
    scrollBackground() {
        //background
             ...
             ctx.drawImage(this.BG_IMG, this.bgX, this.bgY, canvas.width + 100, canvas.height); 
           
             // draw image 2 
           
             ctx.drawImage(this.BG_IMG, this.bgX, this.bgY - canvas.height, canvas.width + 100, canvas.height); 
